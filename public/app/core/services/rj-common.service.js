...
angular.module('app.core').factory('ModalFactory', ModalFactory);
angular.module('app.core').factory('NotifyFactory', NotifyFactory);
angular.module('app.core').factory('AlertFactory', AlertFactory);
